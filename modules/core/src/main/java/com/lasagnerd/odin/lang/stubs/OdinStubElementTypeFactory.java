...
import com.lasagnerd.odin.lang.stubs.types.OdinProcedureDeclarationStubElementType;
...
public class OdinStubElementTypeFactory {
    ...
    public static IStubElementType<?, ?> create(@NotNull String name) {
        return switch (name) {
            ...
            case "PROCEDURE_DECLARATION_STATEMENT" -> new OdinProcedureDeclarationStubElementType(name);
            default -> null;
        };
    }
}
