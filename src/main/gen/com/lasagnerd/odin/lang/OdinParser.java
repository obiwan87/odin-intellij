...
public class OdinParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(COMBINED_PRIMARY, OPERAND_PRIMARY, PRIMARY),
    create_token_set_(ARRAY_INDEX_EXPRESSION, ARRAY_SLICE_EXPRESSION, AUTO_CAST_EXPRESSION, BINARY_EXPRESSION,
      CALL_EXPRESSION, CAST_EXPRESSION, DEREFERENCE_EXPRESSION, EXPRESSION,
      IDENTIFIER_EXPRESSION, IMPLICIT_SELECTOR_EXPRESSION, MATRIX_INDEX_EXPRESSION, MAYBE_EXPRESSION,
      OR_RETURN_EXPRESSION, PARENTHESIZED_EXPRESSION, PRIMARY_EXPRESSION, PROCEDURE_EXPRESSION,
      REFERENCE_EXPRESSION, SET_EXPRESSION, TAG_STATEMENT_EXPRESSION, TERNARY_COND_EXPRESSION,
    ...
    create_token_set_(ASSIGNMENT_STATEMENT, ATTRIBUTE_STATEMENT, BITSET_DECLARATION_STATEMENT, BLOCK_STATEMENT,
      ...
      ENUM_DECLARATION_STATEMENT, EXPRESSION_STATEMENT, FALLTHROUGH_STATEMENT, FIELD_DECLARATION_STATEMENT,
      FILE_SCOPE_STATEMENT, FOREIGN_BLOCK_STATEMENT, FOREIGN_IMPORT_DECLARATION_STATEMENT, FOREIGN_PROCEDURE_DECLARATION_STATEMENT,
      FOREIGN_STATEMENT, FOR_SINGLE_STATEMENT, FOR_STATEMENT, IF_STATEMENT,
  ...
  /* ********************************************************** */
  // operand_primary LBRACKET expression RBRACKET
  public static boolean arrayIndex_expression(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayIndex_expression")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ARRAY_INDEX_EXPRESSION, "<array index expression>");
  ...
  /* ********************************************************** */
  // ((INTEGER_DEC_LITERAL (RANGE_INCLUSIVE|RANGE_EXCLUSIVE) INTEGER_DEC_LITERAL)|INTEGER_DEC_LITERAL) EQ expression
  static boolean arrayIndexedInitialization(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, INTEGER_DEC_LITERAL)) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // (INTEGER_DEC_LITERAL (RANGE_INCLUSIVE|RANGE_EXCLUSIVE) INTEGER_DEC_LITERAL)|INTEGER_DEC_LITERAL
  ...
  // INTEGER_DEC_LITERAL (RANGE_INCLUSIVE|RANGE_EXCLUSIVE) INTEGER_DEC_LITERAL
  private static boolean arrayIndexedInitialization_0_0(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, INTEGER_DEC_LITERAL);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // arrayIndexedInitialization COMMA (arrayIndexedInitialization COMMA)* COMMA?
  static boolean arrayIndexedList(PsiBuilder b, int l) {
    ...
    r = r && arrayIndexedList_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (arrayIndexedInitialization COMMA)*
  private static boolean arrayIndexedList_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayIndexedList_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!arrayIndexedList_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "arrayIndexedList_2", c)) break;
    }
    return true;
  }

  // arrayIndexedInitialization COMMA
  private static boolean arrayIndexedList_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayIndexedList_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = arrayIndexedInitialization(b, l + 1);
    r = r && consumeToken(b, COMMA);
  ...
  // COMMA?
  private static boolean arrayIndexedList_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayIndexedList_3")) return false;
    consumeToken(b, COMMA);
    return true;
  }

  /* ********************************************************** */
  // LBRACKET (expression|QUESTION) RBRACKET typeDefinition_expression LBRACE [arrayIndexedList|arrayExpressionsList] RBRACE
  ...
  private static boolean arrayLiteral_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayLiteral_5")) return false;
    arrayLiteral_5_0(b, l + 1);
    return true;
  }

  // arrayIndexedList|arrayExpressionsList
  private static boolean arrayLiteral_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrayLiteral_5_0")) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // operand_primary LBRACKET expression? COLON expression? RBRACKET
  ...
  public static boolean blockStatement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<block statement>", HASH, LBRACE)) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // (attributeStatement eosRule)* IDENTIFIER COLON typeDefinition_expression? COLON tagStatement_expression? expression
  public static boolean constantInitializationStatement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<constant initialization statement>", AT, IDENTIFIER)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CONSTANT_INITIALIZATION_STATEMENT, "<constant initialization statement>");
    r = constantInitializationStatement_0(b, l + 1);
    r = r && consumeTokens(b, 0, IDENTIFIER, COLON);
    r = r && constantInitializationStatement_3(b, l + 1);
    r = r && consumeToken(b, COLON);
    r = r && constantInitializationStatement_5(b, l + 1);
    r = r && expression(b, l + 1, -1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // (attributeStatement eosRule)*
  ...
  // typeDefinition_expression?
  private static boolean constantInitializationStatement_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constantInitializationStatement_3")) return false;
    typeDefinition_expression(b, l + 1);
    return true;
  }

  // tagStatement_expression?
  private static boolean constantInitializationStatement_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constantInitializationStatement_5")) return false;
    tagStatement_expression(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // ENUM [IDENTIFIER (DOT IDENTIFIER)*] LBRACE ([IDENTIFIER EQ] expression COMMA)* RBRACE
  ...
  // [IDENTIFIER EQ]
  private static boolean enumSpec_3_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enumSpec_3_0_0")) return false;
    parseTokens(b, 0, IDENTIFIER, EQ);
    return true;
  }

  /* ********************************************************** */
  // SEMICOLON | <<eof>> | EOS | <<closingBracket>>
  public static boolean eosRule(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "eosRule")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, EOS_RULE, "<eos rule>");
    r = consumeToken(b, SEMICOLON);
    if (!r) r = eof(b, l + 1);
  ...
  /* ********************************************************** */
  // variableDeclarationStatement|foreignProcedureDeclarationStatement
  public static boolean foreignBlockStatement(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "foreignBlockStatement")) return false;
    if (!nextTokenIs(b, "<foreign block statement>", AT, IDENTIFIER)) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // FOREIGN IMPORT ( IDENTIFIER? DQ_STRING_LITERAL | IDENTIFIER? LBRACE DQ_STRING_LITERAL (COMMA DQ_STRING_LITERAL)* COMMA? RBRACE)
  ...
  private static boolean foreignImportDeclarationStatement_2_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = foreignImportDeclarationStatement_2_1_0(b, l + 1);
    r = r && consumeTokens(b, 0, LBRACE, DQ_STRING_LITERAL);
    r = r && foreignImportDeclarationStatement_2_1_3(b, l + 1);
    r = r && foreignImportDeclarationStatement_2_1_4(b, l + 1);
    r = r && consumeToken(b, RBRACE);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // IDENTIFIER?
  private static boolean foreignImportDeclarationStatement_2_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "foreignImportDeclarationStatement_2_1_0")) return false;
    consumeToken(b, IDENTIFIER);
    return true;
  }

  // (COMMA DQ_STRING_LITERAL)*
  private static boolean foreignImportDeclarationStatement_2_1_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "foreignImportDeclarationStatement_2_1_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!foreignImportDeclarationStatement_2_1_3_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "foreignImportDeclarationStatement_2_1_3", c)) break;
    }
    return true;
  }

  // COMMA DQ_STRING_LITERAL
  private static boolean foreignImportDeclarationStatement_2_1_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "foreignImportDeclarationStatement_2_1_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // COMMA?
  private static boolean foreignImportDeclarationStatement_2_1_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "foreignImportDeclarationStatement_2_1_4")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  /* ********************************************************** */
  // (attributeStatement eosRule)* FOREIGN IDENTIFIER foreignBlock
  ...
  /* ********************************************************** */
  // ((SEMICOLON | NEW_LINE | EOS | <<closingBracket>>)? foreignBlockStatement eosRule)+
  static boolean foreignStatementList(PsiBuilder b, int l) {
  ...
  // (SEMICOLON | NEW_LINE | EOS | <<closingBracket>>)?
  ...
  /* ********************************************************** */
  // [variableInitializationStatement (COMMA variableInitializationStatement)*]
  ...
  // variableInitializationStatement (COMMA variableInitializationStatement)*
  private static boolean ifInit_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ifInit_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = variableInitializationStatement(b, l + 1);
    r = r && ifInit_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (COMMA variableInitializationStatement)*
  private static boolean ifInit_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ifInit_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!ifInit_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "ifInit_0_1", c)) break;
    }
    return true;
  }

  // COMMA variableInitializationStatement
  private static boolean ifInit_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ifInit_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && variableInitializationStatement(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  /* ********************************************************** */
  // IF condition block (eosRule* elseIfBlock)* (eosRule* elseBlock)?
  ...
  private static boolean ifStatement_3_0_0(PsiBuilder b, int l) {
    ...
    while (true) {
      int c = current_position_(b);
      if (!eosRule(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "ifStatement_3_0_0", c)) break;
    }
    return true;
  }
  ...
  private static boolean ifStatement_4_0_0(PsiBuilder b, int l) {
    ...
    while (true) {
      int c = current_position_(b);
      if (!eosRule(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "ifStatement_4_0_0", c)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // (<<isModeOn "PAR">> | <<isModeOff "BLOCK">>)  LBRACE [[IDENTIFIER EQ] expression (COMMA [IDENTIFIER EQ] expression)* COMMA?] RBRACE
  ...
  // [[IDENTIFIER EQ] expression (COMMA [IDENTIFIER EQ] expression)* COMMA?]
  ...
  /* ********************************************************** */
  // operand_primary LBRACKET expression COMMA expression RBRACKET
  ...
  /* ********************************************************** */
  // LBRACKET CARET RBRACKET typeType
  ...
  /* ********************************************************** */
  // packageClause eosRule (importDeclarationStatement eosRule)* (fileScopeStatement eosRule)* <<eof>>
  ...
  // (importDeclarationStatement eosRule)*
  ...
  public static boolean procedureDeclarationStatement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, AT)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, PROCEDURE_DECLARATION_STATEMENT, null);
  ...
  private static boolean procedureDeclarationStatement_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = attributeStatement(b, l + 1);
    r = r && procedureDeclarationStatement_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // EOS*
  private static boolean procedureDeclarationStatement_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procedureDeclarationStatement_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!consumeToken(b, EOS)) break;
      if (!empty_element_parsed_guard_(b, "procedureDeclarationStatement_0_1", c)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // tagStatement_expression? PROC string_literal? LPAREN parameterList* RPAREN [ARROW (returnType|NOT)] <<enterMode "BLOCK">> [whereClause] <<exitMode "BLOCK">>
  ...
  private static boolean procedureType_6_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, ARROW);
    r = r && procedureType_6_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // returnType|NOT
  private static boolean procedureType_6_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procedureType_6_0_1")) return false;
    boolean r;
    r = returnType(b, l + 1);
  ...
  /* ********************************************************** */
  // LPAREN parameterList RPAREN | typeDefinition_expression
  ...
  /* ********************************************************** */
  // ((SEMICOLON | NEW_LINE | EOS | <<closingBracket>>)? statement eosRule)+
  ...
  /* ********************************************************** */
  // STRUCT [LPAREN parameterList RPAREN [WHERE expression]] tagStatement_expression? LBRACE [fieldDeclarationStatement (COMMA fieldDeclarationStatement)* COMMA?] RBRACE
  ...
  private static boolean structSpec_4_0(PsiBuilder b, int l) {
    ...
    r = r && structSpec_4_0_1(b, l + 1);
    r = r && structSpec_4_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (COMMA fieldDeclarationStatement)*
  private static boolean structSpec_4_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "structSpec_4_0_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!structSpec_4_0_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "structSpec_4_0_1", c)) break;
    }
    return true;
  }

  // COMMA fieldDeclarationStatement
  private static boolean structSpec_4_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "structSpec_4_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
  ...
  // COMMA?
  private static boolean structSpec_4_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "structSpec_4_0_2")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  public static boolean switchCondition(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "switchCondition")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, SWITCH_CONDITION, "<switch condition>");
  ...
  /* ********************************************************** */
  // tagStatement_expression? SWITCH IN? <<enterMode "BLOCK">> switchCondition? <<exitMode "BLOCK">> LBRACE (switchCaseBlock)* RBRACE
  ...
  // (switchCaseBlock)*
  private static boolean switchStatement_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "switchStatement_7")) return false;
    while (true) {
      int c = current_position_(b);
      if (!switchStatement_7_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "switchStatement_7", c)) break;
    }
    return true;
  }

  // (switchCaseBlock)
  private static boolean switchStatement_7_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "switchStatement_7_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  public static boolean typeType(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, TYPE_TYPE, "<type type>");
    r = mapType(b, l + 1);
    ...
    if (!r) r = typeType_11(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // DOLLAR? primary_expression
  private static boolean typeType_11(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "typeType_11")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = typeType_11_0(b, l + 1);
    r = r && primary_expression(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // DOLLAR?
  private static boolean typeType_11_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "typeType_11_0")) return false;
    consumeToken(b, DOLLAR);
    return true;
  }
  ...
  /* ********************************************************** */
  // LBRACE typeDefinition_expression (COMMA typeDefinition_expression)* COMMA? RBRACE
  ...
  /* ********************************************************** */
  // (attributeStatement eosRule?)* IDENTIFIER (COMMA IDENTIFIER)* COLON typeDefinition_expression
  ...
  /* ********************************************************** */
  // (attributeStatement eosRule*)* identifierList COLON typeDefinition_expression? EQ expressionsList
  public static boolean variableInitializationStatement(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<variable initialization statement>", AT, IDENTIFIER)) return false;
    boolean r;
    ...
    r = r && consumeToken(b, COLON);
    r = r && variableInitializationStatement_3(b, l + 1);
    r = r && consumeToken(b, EQ);
    r = r && expressionsList(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  // typeDefinition_expression?
  private static boolean variableInitializationStatement_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "variableInitializationStatement_3")) return false;
    typeDefinition_expression(b, l + 1);
    return true;
  }
  ...
  // 5: POSTFIX(dereference_expression)
  // 6: POSTFIX(maybe_expression)
  ...
  // 12: ATOM(cast_expression)
  // 13: ATOM(transmute_expression)
  // 14: PREFIX(auto_cast_expression)
  ...
  public static boolean expression_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      ...
      else if (g < 6 && consumeTokenSmart(b, DOT_QUESTION)) {
        r = true;
        exit_section_(b, l, m, MAYBE_EXPRESSION, r, true, null);
      }
      else if (g < 8 && binaryOperator(b, l + 1)) {
        r = expression(b, l, 8);
  ...
  public static boolean primary_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      Marker m = enter_section_(b, l, _LEFT_, null);
      if (g < 1 && combined_primary_0(b, l + 1)) {
        r = true;
